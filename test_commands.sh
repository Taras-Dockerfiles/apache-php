...
docker buildx build --no-cache --progress=plain --push --platform linux/amd64,linux/arm64/v8 --rm -t wujidadi/ap:3.15-php8.3 . 2>&1 | tee $D/docker-build-ap-3.15-php8.3.log
